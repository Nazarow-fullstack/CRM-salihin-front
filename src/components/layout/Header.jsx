        ...
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-slate-200/80 dark:border-white/10 bg-white/80 dark:bg-[#0f172a]/80 px-6 backdrop-blur-md shadow-sm">
            <div className="flex items-center gap-4">
                ...
                <Button
                    ...
                    className="md:hidden text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/5"
                >
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-lg font-bold bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent hidden sm:block">
                        Saliheen CRM
                    </span>
                </div>
            </div>
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="relative group">
                    <Button variant="ghost" size="icon" className="rounded-full text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/5">
                ...
                <div className="relative">
                    <button
                        ...
                        className="flex items-center gap-3 rounded-full border border-slate-200 dark:border-white/10 bg-white/70 dark:bg-white/5 p-1 pl-4 pr-2 transition-all hover:bg-white dark:hover:bg-white/10 hover:border-slate-300 dark:hover:border-white/20"
                    >
